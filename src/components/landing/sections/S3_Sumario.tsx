...
import { book, chapters } from '@/lib/design-tokens';
import { cn } from '@/lib/utils';

export function S3_Sumario() {
  ...
  return (
    <Section id="conteudo">
      <SectionHeader
        eyebrow="Conteúdo"
        heading="O que você vai dominar."
        subheading="Da fisiologia integrativa ao laudo assinado: o método MEV 3.0 em onze capítulos."
      />
          ...
          return (
            <li
              ...
              className={cn(
                ...
                isOpen ? 'border-mateus-primary/30' : 'border-mateus-accent/15'
              )}
            >
              <button
                type="button"
              ...
              >
                <span className="font-serif font-semibold text-mateus-gold text-lg leading-none mt-1 w-8 flex-shrink-0">
                  ...
                  >
                    <ul className="pl-16 pr-5 pb-5 space-y-2">
                      {ch.takeaways.map((t, idx) => (
                        ...
                        >
                          <span className="text-mateus-gold flex-shrink-0">·</span>
                          <span>{t}</span>
                        </li>
                      ))}
                    </ul>
