...
import { passagesMev } from '@/lib/design-tokens';
import { cn } from '@/lib/utils';

export function MevS4_PagePractice() {
  return (
    <Section id="metodo" alt>
      <SectionHeader
        eyebrow="Da página para a prática"
        heading="6 pilares no livro. 6 pilares operacionalizados na Plataforma AMA."
        subheading="O método deste livro está rodando agora em produção. Quem lê o livro entende a Plataforma. Quem usa a Plataforma volta ao livro."
      />
            ...
            >
              <div className="relative">
                <p className="eyebrow mb-3">
                  <span className="text-mateus-lilas">Trecho {i + 1}</span> · {p.theme}
                </p>
                <article
                  className={cn(
                    ...
                    'before:bg-gradient-to-b before:from-mateus-lilas/0 before:via-mateus-lilas/40 before:to-mateus-lilas/0'
                  )}
                >
      ...
      <div className="mt-16 text-center">
        <a
          ...
          className="inline-flex items-center gap-2 text-sm text-mateus-primary hover:text-mateus-lilas transition-colors underline-offset-4 underline"
        >
